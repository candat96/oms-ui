export const API_CONSTANT = {
  API_WAREHOUSE: 'storage-category',
  API_UNIT: 'calculation-unit',
  API_WAREHOUSE_RECEIPT: 'warehouse-receipt-tickets',
  ...
  API_SUPPLY: 'supplies-category',
  API_PROVIDER: 'provider-category'
}
